...
CREATE DATABASE BD_TRIATLON_Redwin
GO
...
CREATE TABLE INSTITUTOS(
	...
	Email1_Instituto	varchar(30) NOT NULL,
	Email2_Instituto	varchar(30),
...
CREATE TABLE ENTRENADORES(
	...
	ID_Entrenador				varchar(30) NOT NULL, -- UNIQUE
	...
	Telefono1_Entrenador		varchar(25) NOT NULL,
	Telefono2_Entrenador		varchar(25),
	Email1_Entrenador			varchar(30) NOT NULL,
	Email2_Entrenador			varchar(30),
...
CREATE TABLE ATLETAS(
	Cod_Atleta					int IDENTITY, -- PK
	ID_Atleta					varchar(30) NOT NULL,
	Nombre_Atleta				varchar(20) NOT NULL,
	Apellido1_Atleta			varchar(20) NOT NULL,
	Apellido2_Atleta			varchar(20) NOT NULL,
	Nacimiento_Atleta			date NOT NULL,
	Telefono1_Atleta			varchar(25) NOT NULL,
	Telefono2_Atleta			varchar(25),
	Email1_Atleta				varchar(30) NOT NULL,
	Email2_Atleta				varchar(30),
	Distrito_Atleta				varchar(30) NOT NULL,
	Canton_Atleta				varchar(30) NOT NULL,
	Provincia_Atleta			varchar(10) NOT NULL,
	Pais_Atleta					varchar(20) NOT NULL,
	Direccion_Atleta			varchar(150) NOT NULL,
	Observacion_Atleta			varchar(150),
	Activo_Atleta				bit
);

CREATE TABLE MATRICULAS(
	Cod_Matricula				int IDENTITY, -- PK
	Cod_Atleta					int NOT NULL, -- FK
...
ALTER TABLE ENTRENADORES ADD
	...
	CONSTRAINT CHK_Provincia_Entrenador CHECK (Provincia_Entrenador = upper(Provincia_Entrenador) AND 
		Provincia_Entrenador IN ('SAN JOSÉ','ALAJUELA','CARTAGO','HEREDIA','GUANACASTE','PUNTARENAS','LIMÓN','OTRO'))
;
...
-- _______________________  ATLETAS  _______________________

ALTER TABLE ATLETAS ADD
	-- PK
	CONSTRAINT PK_Cod_Atleta PRIMARY KEY  (Cod_Atleta),
	-- UC
	CONSTRAINT UC_ID_Atleta UNIQUE (ID_Atleta),
	-- CHK
	CONSTRAINT CHK_Provincia_Atleta CHECK (Provincia_Atleta = UPPER(Provincia_Atleta) AND 
		Provincia_Atleta IN ('SAN JOSÉ','ALAJUELA','CARTAGO','HEREDIA','GUANACASTE','PUNTARENAS','LIMÓN','OTRO'))
;
...
ALTER TABLE MATRICULAS ADD
	...
	-- FK
	CONSTRAINT FK_MATRICULAS_ATLETAS FOREIGN KEY (Cod_Atleta)
