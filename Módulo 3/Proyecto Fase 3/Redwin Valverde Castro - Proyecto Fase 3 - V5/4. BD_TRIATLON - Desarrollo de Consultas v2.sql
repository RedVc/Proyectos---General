...
-- 1 -- INNER JOIN
-- Los entrenadores y el instituto al que pertenecen.
...
-- 2 -- INNER JOIN
-- Los entrenadores y el horario en el que imparten lecciones.
...
-- 3 --	LEFT JOIN
-- Entrenadores y los módulos que imparten.
...
-- 4 -- LEFT JOIN
-- Los módulos y el programa al que pertenecen.
...
-- 5 -- RIGHT JOIN
-- Estudiantes y el estado de su matrícula.
...
-- 6 -- RIGHT JOIN
-- Entrenadores y la fecha laborada
...
SELECT	UPPER(Nombre_Entrenador) AS 'Nombre entrenador', FLOOR(Costo_Modulo) AS COSTO, Inicio_Mod_A AS Inicio
